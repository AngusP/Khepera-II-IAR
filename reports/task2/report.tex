...
\begin{abstract}
  ...
  %ANGUS - atop %JEVGENIJ atop is a word
  %I drew a diaram where  I call it hybryd subsumptions etc, need t odiscuss
...
This new navigational behaviour is bolted-on to the simpler reactive wall-following
and collision avoidance code from \textit{Task1}, in a hybrid-subsumtive sense where the
...
allows an easy transition towards SLAM (hint hint). % JEVGENIJ: I like it. Cheeky fuck.
