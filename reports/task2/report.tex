...
The reference pane transformation is performed by a ${3x3}$ matrix 
...
Attempts to correct the algorithmic flaws were made as per above and the %TODO insert ref to algo section
